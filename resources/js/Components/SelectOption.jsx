                ...
                <>
                    ...
                    <div className="relative">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0"
                        >
                            <Listbox.Options className={`absolute right-0 z-10 mt-2 w-72 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}>
                                {items.map((option) => (
                                    <Listbox.Option
                                        key={option.value}
                                        className={({ active }) =>
                                    ...
                                    >
                                        {({ selected, active }) => (
                                            <div className="flex flex-col">
                                                <div className={`flex justify-between ${option.color}`}>
                                                    <p
                                                        className={
                                                            selected
                                                                ? "font-semibold"
